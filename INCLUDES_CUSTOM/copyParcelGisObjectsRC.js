function copyParcelGisObjectsRC(sCapID, tCapID) {
	var capParcelResult = aa.parcel.getParcelandAttribute(sCapID, null);
			...
			for (a1 in fGisObj) // for each GIS object on the Cap
			{
				...
				var gisObjArray = gisTypeScriptModel.getGISObjects()
					for (b1 in gisObjArray) {
						...
						var retval = aa.gis.addCapGISObject(tCapID, gisObjModel.getServiceID(), gisObjModel.getLayerId(), gisObjModel.getGisId());
