...
email('Marissa.Ostos@cityofrc.us, scott.rapp@cityofrc.us, princess.wilson@cityofrc.us, sid.siphomsay@cityofrc.us','noreply@cityofrc.us','A new CDD record was created: ' + childIdCDDAltId,'Please use Accela Automation to review the CDD Record ' +childIdCDDAltId + '. The PMT associated with this record is ' + capId.getCustomID() + ' with the primary address of ' + priAddrRec + '.');
