function bldSolarFee() {
	...
	//start replaced branch: BuildingSolarFee:Lookup
	{
		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar/Photovoltaic-Residential' && (WORKDESCRIPTION[xxx]['Kilowatts'] * 1) > 0)
					newRSolarTotal += 145.00;
			comment('What is newRSolarTotal = ' + newRSolarTotal);
		}

		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar/Photovoltaic-Residential' && (WORKDESCRIPTION[xxx]['Kilowatts'] * 1) > 15)
					newRSolarTotal += Math.ceil(((WORKDESCRIPTION[xxx]['Kilowatts'] * 1) - 15)) * 15.00;
		}

		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar/Photovoltaic-Residential w/ electrical service upgrade' && (WORKDESCRIPTION[xxx]['Kilowatts'] * 1) > 0)
					newRSolarTotal += 407.00;
			comment('What is newRSolarTotal = ' + newRSolarTotal);
		}

		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar/Photovoltaic-Residential w/ electrical service upgrade' && (WORKDESCRIPTION[xxx]['Kilowatts'] * 1) > 15)
					newRSolarTotal += Math.ceil(((WORKDESCRIPTION[xxx]['Kilowatts'] * 1) - 15)) * 15.00;
		}

		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar/Photovoltaic-Commercial' && (WORKDESCRIPTION[xxx]['Kilowatts'] * 1) > 0)
					newRSolarTotal += 498.00;
			comment('What is newRSolarTotal = ' + newRSolarTotal);
		}

		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar/Photovoltaic-Commercial' && (WORKDESCRIPTION[xxx]['Kilowatts'] * 1) > 250)
					newRSolarTotal += Math.ceil(((WORKDESCRIPTION[xxx]['Kilowatts'] * 1) - 250)) * 5.00;
		}

		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar Water System')
					newRSolarTotal += parseInt(WORKDESCRIPTION[xxx]['Quantity']) * 328.00;
			comment('What is newRSolarTotal = ' + newRSolarTotal);
		}

		if (typeof(WORKDESCRIPTION) == 'object') {
			for (xxx in WORKDESCRIPTION)
				if (WORKDESCRIPTION[xxx]['Type of Work'] == 'Solar Power Storage System')
					newRSolarTotal += parseInt(WORKDESCRIPTION[xxx]['Quantity']) * 315.00;
			comment('What is newRSolarTotal = ' + newRSolarTotal);
		}
