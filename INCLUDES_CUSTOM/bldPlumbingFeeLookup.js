...
if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Utility Connection') newPlbTotal += PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] * 138;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Plumbing or gas fixtures' && PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] < 6) newPlbTotal += 394;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Plumbing or gas fixtures' && PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] > 5) newPlbTotal += (Math.ceil(((PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) - 5)) * 164.00) + 394.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Private sewage disposal system- commercial') newPlbTotal += PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] * 394;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Repair drain line, sewer line, water service or gas line- commercial') newPlbTotal += PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] * 262;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Tankless water heater - commercial') newPlbTotal += PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] *328;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Solar water system - commercial') newPlbTotal += PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] * 787;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Medical Gas system') newPlbTotal += PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] * 951;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Sewer / Water Service Connection') newPlbTotal += (PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) * 164.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Plumbing or Gas Fixtures' && PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] < 6) newPlbTotal += 197.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Plumbing or Gas Fixtures' && PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] > 5) newPlbTotal += (Math.ceil(((PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) - 5)) * 33.00) + 197.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Re-piping up to 20 Fixtures') newPlbTotal += 262.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Water Service Line') newPlbTotal += (PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) * 164.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Backflow Preventer' && PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] < 6) newPlbTotal += 197.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Backflow Preventer' && PLUMBINGINFORMATIONTABLE[xxx]['Quantity'] > 5) newPlbTotal += (Math.ceil(((PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) - 5)) * 13.00) + 197.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Water Heater') newPlbTotal += (PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) * 131.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Tankless Water Heater') newPlbTotal += (PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) * 197.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Graywater System') newPlbTotal += (PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) * 131.00;
	}

if (typeof(PLUMBINGINFORMATIONTABLE) == 'object') {
	for (xxx in PLUMBINGINFORMATIONTABLE) if (PLUMBINGINFORMATIONTABLE[xxx]['Plumbing Type'] == 'Repair - Drain Line, Sewer Line, Water Service, or Gas Line') newPlbTotal += (PLUMBINGINFORMATIONTABLE[xxx]['Quantity']*1) * 131.00;
	}
