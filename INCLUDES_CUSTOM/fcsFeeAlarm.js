...
if (typeof(FIREALARMDETAIL) == 'object') {
	for (xxx in FIREALARMDETAIL) if (FIREALARMDETAIL [xxx]['Type of Use'] == 'Fire Alarm and Sprinkler Monitoring System' && FIREALARMDETAIL[xxx]['Quantity'] > 0 && FIREALARMDETAIL[xxx]['Quantity'] <= 15) newFCSAlarmTotal += 722.00;
	}

if (typeof(FIREALARMDETAIL) == 'object') {
	for (xxx in FIREALARMDETAIL) if (FIREALARMDETAIL [xxx]['Type of Use'] == 'Fire Alarm and Sprinkler Monitoring System' && FIREALARMDETAIL[xxx]['Quantity'] > 15 && FIREALARMDETAIL[xxx]['Quantity'] <= 50) newFCSAlarmTotal += 984.00;
	}

if (typeof(FIREALARMDETAIL) == 'object') {
	for (xxx in FIREALARMDETAIL) if (FIREALARMDETAIL [xxx]['Type of Use'] == 'Fire Alarm and Sprinkler Monitoring System' && FIREALARMDETAIL[xxx]['Quantity'] > 50 && FIREALARMDETAIL[xxx]['Quantity'] <= 100) newFCSAlarmTotal += 1246.00;
	}

if (typeof(FIREALARMDETAIL) == 'object') {
	for (xxx in FIREALARMDETAIL) if (FIREALARMDETAIL [xxx]['Type of Use'] == 'Fire Alarm and Sprinkler Monitoring System' && FIREALARMDETAIL[xxx]['Quantity'] > 100 && FIREALARMDETAIL[xxx]['Quantity'] <= 500) newFCSAlarmTotal += 1903.00;
	}

if (typeof(FIREALARMDETAIL) == 'object') {
	for (xxx in FIREALARMDETAIL) if (FIREALARMDETAIL [xxx]['Type of Use'] == 'Fire Alarm and Sprinkler Monitoring System' && FIREALARMDETAIL[xxx]['Quantity'] > 500) newFCSAlarmTotal += (Math.ceil((parseInt(FIREALARMDETAIL[xxx]['Quantity']) - 500)/25) * 157.00) + 1903.00;
	}

if (typeof(FIREALARMDETAIL) == 'object') {
	for (xxx in FIREALARMDETAIL) if (FIREALARMDETAIL [xxx]['Type of Use'] == 'Refrigerant Monitoring System') newFCSAlarmTotal += parseFloat(FIREALARMDETAIL [xxx]['Quantity']) * 787.00;
...
if (newFCSAlarmTotal > 0) {
	updateFee('FCS011','FCS_STANDARD','FINAL', newFCSAlarmTotal,'N');
	updateFee('FCS021','FCS_STANDARD','FINAL', newFCSAlarmTotal,'N');
