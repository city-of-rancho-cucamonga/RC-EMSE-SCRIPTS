function fcsFeeMisc() {
	...
	//start replaced branch: FCS_MiscFee:Lookup
	{
		...
		if (typeof(FIREMISCELLANEOUSDETAIL) == 'object') {
			for (xxx in FIREMISCELLANEOUSDETAIL)
				if (FIREMISCELLANEOUSDETAIL[xxx]['Type of Use'] == 'High Pile Storage' && parseFloat(FIREMISCELLANEOUSDETAIL[xxx]['Quantity']) <= 25000)
					newFCSMiscTotal += 918.00;
			comment('What is ' + FIREMISCELLANEOUSDETAIL[xxx]['Type of Use'] + ' ' + newFCSMiscTotal);
		}

		if (typeof(FIREMISCELLANEOUSDETAIL) == 'object') {
			for (xxx in FIREMISCELLANEOUSDETAIL)
				if (FIREMISCELLANEOUSDETAIL[xxx]['Type of Use'] == 'High Pile Storage' && parseFloat(FIREMISCELLANEOUSDETAIL[xxx]['Quantity']) > 25000 && parseFloat(FIREMISCELLANEOUSDETAIL[xxx]['Quantity']) <= 100000)
					newFCSMiscTotal += 1181.00;
			comment('What is ' + FIREMISCELLANEOUSDETAIL[xxx]['Type of Use'] + ' ' + newFCSMiscTotal);
		}

		if (typeof(FIREMISCELLANEOUSDETAIL) == 'object') {
			for (xxx in FIREMISCELLANEOUSDETAIL)
				if (FIREMISCELLANEOUSDETAIL[xxx]['Type of Use'] == 'High Pile Storage' && parseFloat(FIREMISCELLANEOUSDETAIL[xxx]['Quantity']) > 100000)
					newFCSMiscTotal += (Math.ceil((parseFloat(FIREMISCELLANEOUSDETAIL[xxx]['Quantity']) - 100000) / 100000) * 262.00) + 1181.00;
			comment('What is ' + FIREMISCELLANEOUSDETAIL[xxx]['Type of Use'] + ' ' + newFCSMiscTotal);
		}
