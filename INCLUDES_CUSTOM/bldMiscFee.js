...
if (typeof(TYPESOFWORK) == 'object') {
	...
	if (newMisc100Total > 0) {
		updateFee('MI001', 'BLD_MISC', 'FINAL', newMisc100Total*1.026*1.029*1.023, 'N');
	}

	if (newMiscTotal > 0) {
		updateFee('MI001', 'BLD_MISC', 'FINAL', (newMiscTotal*1.026*1.029*1.023 * .50) + newMisc100Total, 'N');
		updateFee('MI001.01', 'BLD_MISC', 'FINAL', newMiscTotal*1.026*1.029*1.023 * .50, 'N');
