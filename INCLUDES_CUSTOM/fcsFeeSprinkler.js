...
if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Call I, II, & III Stand Pipe') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 262.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Clean Agent Gas Systems') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 918.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Deluge / Pre-Action') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 918.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Dry Chemical Systems') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 787.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Dry Pipe Valve') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 105.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Fire Pumps') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 984.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems (Production - SFR Tract Homes and Multi-Family)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>0 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=20) newFCSSprinklerTotal += 262.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems (Production - SFR Tract Homes and Multi-Family)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>20 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=100) newFCSSprinklerTotal += 525.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems (Production - SFR Tract Homes and Multi-Family)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>100 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=200) newFCSSprinklerTotal += 590.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems (Production - SFR Tract Homes and Multi-Family)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>200 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=350) newFCSSprinklerTotal += 656.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems (Production - SFR Tract Homes and Multi-Family)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>350) newFCSSprinklerTotal += 787.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems for New Construction' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>0 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=20) newFCSSprinklerTotal += 459.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems for New Construction' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>20 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=100) newFCSSprinklerTotal += 787.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems for New Construction' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>100 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=200) newFCSSprinklerTotal += 918.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems for New Construction' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>200 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=350) newFCSSprinklerTotal += 1050.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Systems for New Construction' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>350) newFCSSprinklerTotal += 1246.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Tenant Improvements (Commercial)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>0 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=4) newFCSSprinklerTotal += 394.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Tenant Improvements (Commercial)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>4 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=20) newFCSSprinklerTotal += 525.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Tenant Improvements (Commercial)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>20 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=100) newFCSSprinklerTotal += 656.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Tenant Improvements (Commercial)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>100 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=200) newFCSSprinklerTotal += 787.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Tenant Improvements (Commercial)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>200 && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']<=350) newFCSSprinklerTotal += 918.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL [xxx]['Type of Use'] == 'Fire Sprinkler Tenant Improvements (Commercial)' && FIRESPRINKLERFLOORDETAIL [xxx]['Quantity']>350) newFCSSprinklerTotal += 1181.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Foam Systems') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 525.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Hydraulic Calculations') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 131.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Misc. FD Access') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 131.00;
	}

if (typeof(FIRESPRINKLERFLOORDETAIL) == 'object') {
	for (xxx in FIRESPRINKLERFLOORDETAIL) if (FIRESPRINKLERFLOORDETAIL[xxx]['Type of Use'] == 'Wet Chemical / Kitchen Hood') newFCSSprinklerTotal += parseFloat(FIRESPRINKLERFLOORDETAIL[xxx]['Quantity']) * 525.00;
	}
