...
if (typeof(FIREUNDERGROUNDDETAIL) == 'object') {
	for (xxx in FIREUNDERGROUNDDETAIL) if (FIREUNDERGROUNDDETAIL [xxx]['Type of Use'] == 'Private Underground Fire Service' && FIREUNDERGROUNDDETAIL [xxx]['Quantity'] <= 5) newFCSUnderTotal += 656.00;
	}

if (typeof(FIREUNDERGROUNDDETAIL) == 'object') {
	for (xxx in FIREUNDERGROUNDDETAIL) if (FIREUNDERGROUNDDETAIL [xxx]['Type of Use'] == 'Private Underground Fire Service' && FIREUNDERGROUNDDETAIL [xxx]['Quantity'] > 5) newFCSUnderTotal += ((parseInt(FIREUNDERGROUNDDETAIL [xxx]['Quantity']) - 5) * 262.00) + 656.00;
	}
...
if (newFCSUnderTotal > 0) {
	updateFee('FCS011','FCS_STANDARD','FINAL', newFCSUnderTotal,'N');
	updateFee('FCS021','FCS_STANDARD','FINAL', newFCSUnderTotal,'N');
	}
