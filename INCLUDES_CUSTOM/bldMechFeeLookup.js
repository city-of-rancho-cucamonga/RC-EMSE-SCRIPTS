...
if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'HVAC System - Residential') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 262.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Exhaust Hood, Vent Fan, Vent System, Heating Unit, Compressor, or Evaporative cooler - Res/Com') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 250.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Package Unit or Split System - Residential') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 197.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Ductwork Only') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 131.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Exhaust Hood Type I - Commercial') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 744.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Dust Collection System - Commercial') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 1357.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Cooling Tower or Heat Exchange - Commercial') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 878.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Exhaust Hood Type II or Other Ventilation System - Commercial') newMecTotal += Math.ceil(parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity'])) * 548.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Freezer/Cooler - Commercial' && parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity']) <= 500) newMecTotal +=  416.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Freezer/Cooler - Commercial' && parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity']) > 500 && parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity']) <= 50000) newMecTotal +=  810.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}

if (typeof(MECHANICALINFORMATIONTABLE) == 'object') {
	for (xxx in MECHANICALINFORMATIONTABLE) if (MECHANICALINFORMATIONTABLE[xxx]['Mechanical Type'] == 'Freezer/Cooler - Commercial' && parseFloat(MECHANICALINFORMATIONTABLE[xxx]['Quantity']) > 50000) newMecTotal +=  1007.00;
	comment('What is newMecTotal = ' + newMecTotal);
	}
