...
for (x in wfAsgnArray) if (matches(x,'Follow-Up Inspection','Permit Coordination','Permit Issuance','Court Process','Administrative Citation Hearing Process') && wfAsgnArray[x].active == 'Y') openWFTasks=true;
