...
if (wfTask == 'Review Consolidation' && wfStatus == 'Approved') {
	...
	email('Jennifer.Quan@cityofrc.us, sid.siphomsay@cityofrc.us, tammie.graciano@cityofrc.us,shane.adams@cityofrc.us', 'noreply@accela.com', 'Operation Permit Required for HPS', ' Record # ' + capIDString + ' An Operation Permit is required. Please review and respond accordingly.');
}
