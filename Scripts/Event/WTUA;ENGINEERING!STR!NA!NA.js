...
if (wfTask == 'Application Submittal' && wfStatus == 'Accepted') 
{
	...
	email('Sid.Siphomsay@cityofrc.us,Adriana.SantaCruz@cityofrc.us', 'AA-NoReply@cityofrc.us', 'Invoiced Fee has been applied on: ' + capIDString, 'The primary address on this permit is ' + priAddrRec + '. Please review it and respond accordingly.');
=======
if (wfTask == 'Application Submittal' && wfStatus == 'Accepted') 
{
	priAddrRec = priAddressOnCap();
...
if (wfTask == 'Application Submittal' && wfStatus == 'Invoiced Fees') 
{
	priAddrRec = priAddressOnCap();
<<<<<<< HEAD
	email('Sid.Siphomsay@cityofrc.us,Albert.Espinoza@cityofrc.us,Dean.Rodia@cityofrc.us,Lucas.Mitchell@cityofrc.us', 'AA-NoReply@cityofrc.us', 'Invoiced Fee has been applied on: ' + capIDString, 'The primary address on this permit is ' + priAddrRec + '. Please review it and respond accordingly.');
}
...

{
	priAddrRec = priAddressOnCap();
<<<<<<< HEAD
	email('Sid.Siphomsay@cityofrc.us,Albert.Espinoza@cityofrc.us,Dean.Rodia@cityofrc.us,Lucas.Mitchell@cityofrc.us', 'AA-NoReply@cityofrc.us', 'The Street Tree Removal and Replacement Application is closed on: ' + capIDString, 'The primary address on this permit is ' + priAddrRec + '. Please review it and respond accordingly.');
}
