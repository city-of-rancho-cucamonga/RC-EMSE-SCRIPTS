...
if (inspType == 'Drywall, Nailing, Interior Lath') {
	email('sid.siphomsay@cityofrc.us, 'noreply@accela.com', 'Drywall, Nailing, Interior Lath inspection notification for ' + capIDString + '', 'Drywall, Nailing, Interior Lath inspection has been scheduled for Record# ' + capIDString + '. Please respond accordingly');
}