...
if (inspType == 'Final Inspection' && inspResult == 'Approved' && AInfo['FIRE SITE INFO RECORD.Operational Permit Required'] == 'Yes') {
	email('sid.siphomsay@cityofrc.us', 'noreply@accela.com', 'Operational Permit Required for ' + capIDString + '', 'Final Inspection has been approved for Record# ' + capIDString + '. Please respond accordingly');
}
