...
if (inspType == 'Initial Inspection' && !matches(inspResult,'Duplicate Case','Referred to Comm Improvement','Unfounded')) {
	var nxtinstype = '';
	if (inspResult == 'No Contact /Reschedule' || inspResult == 'Note') nxtinstype = 'Initial Inspection';
	else nxtinstype = 'Follow-up Inspection';
	var nxtinpnumberofday = 0;
	if (inspResult == 'Founded - 1 day') nxtinpnumberofday = 1;
	else if (inspResult == 'No Contact /Reschedule' || inspResult == 'Note' || inspResult == 'Founded - 3 days') nxtinpnumberofday = 3;
	else if (inspResult == 'Founded - 10 days') nxtinpnumberofday = 10;
	else nxtinpnumberofday = 30;
